...
<div class="container-fluid my-0 py-0">
    <div class="row hero">
        <div class="col-8 offset-1 d-flex align-items-center">
            <div>
                <h1 class="text-white font-weight-bold text-capitalize">PT. Pencari Cinta Sejati</h1>
                <h4 class="text-white">Perusahaan yang bergerak di bidang pengembangan asmara.</h4>
            </div>
        </div>
    </div>
</div>
...
<div class="container pb-5" id="announcements">
    ...
    @if (count($recruitments) > 0)
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-12 mb-2">
                <div class="card mx-3 h-100">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('welcome.recruitments.show', ['recruitment' => $recruitment->id ]) }}" class="btn btn-primary">Lebih Banyak</a>
                    </div>
                </div>
            </div>
            @endforeach
        ...
        <div class="row mt-2 float-right mr-1">
            <div class="col-12">
                <a href="{{ route('welcome.recruitments') }}" class="btn btn-primary">Lowongan Sebelumnya</a>
            </div>
        </div>
    @endif
