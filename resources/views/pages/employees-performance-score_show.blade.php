...
<div class="container-fluid mt-2 px-4">
  <div class="row">
    <div class="col-12">
        <h4 class="font-weight-bold">Skor Performa Pegawai</h4>
        <hr>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-12">
        <h5 class="text-center font-weight-bold mb-3">Detai Skor Pegawai</h5>
        <div class="mb-3">
          <h6 class="font-weight-bold">Informasi Pegawai</h6>
          <hr>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-lg-6">
              <div class="form-group">
                <label for="scored_by">Dinilai Oleh:</label>
    ...
    <div class="row">
      <div class="col-12">
        ...
        <form action="{{ route('employees-performance-score.destroy', ['employeeScore' => $employeeScore->group_id]) }}" method="POST" class="d-inline-block">
          @csrf
          @method('DELETE')
          <button type="submit" class="btn btn-danger mr-2 px-5" onclick="return confirm('Are you sure deleting this scores?')">Hapus</button>
        </form>
      </div>
    </div>
  @endif
