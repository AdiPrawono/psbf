...
<div class="container-fluid mt-2 px-4">
  ...
  <div class="row">
    <div class="col-12">
        <h5 class="text-center font-weight-bold mb-3">Detail Permintaan Cuti Pegawai</h5>
        <div class="mb-3">
            <div class="row">
              <div class="col-12">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="acceptModalLabel">Terima</h5>
      ...
      <form action="{{ route('employees-leave-request.update', ['employeeLeaveRequest' => $employeeLeaveRequest->id]) }}" method="POST" class="d-inline-block">
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-success mr-2 px-5">Terima</button>
        </div>
      </form>
    </div>
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('employees-leave-request.destroy', ['employeeLeaveRequest' => $employeeLeaveRequest->id]) }}" method="POST" class="d-inline-block">
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-danger mr-2 px-5">Tolak</button>
        </div>
      </form>
    </div>
  </div>
