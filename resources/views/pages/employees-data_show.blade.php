...
<div class="container-fluid mt-2 px-4">
  <div class="row">
    <div class="col-12">
        <h4 class="font-weight-bold">Data Pegawai</h4>
        <hr>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-12">
      <h5 class="text-center font-weight-bold mb-3">Detail Pegawai</h5>
    </div>
  </div>
    ...
    <div class="col-md-12 col-lg-8">
      ...
      <div class="mb-3">
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-6">
            <div class="form-group">
              <label for="start_of_contract">Mulai Kontrak:</label>
          ...
          <div class="col-sm-12 col-lg-6">
            <div class="form-group">
              <label for="end_of_contract">Akhir Kontrak:</label>
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-6">
            <div class="form-group">
              <label for="work_experience_in_years">Pengalaman Kerja:</label>
